...
class SimulationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Simulate = channel.unary_unary(
                ...
                request_serializer=simulation__pb2.SimulateRequest.SerializeToString,
                response_deserializer=simulation__pb2.SimulateResponse.FromString,
...
def add_SimulationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Simulate': grpc.unary_unary_rpc_method_handler(
                    servicer.Simulate,
                    request_deserializer=simulation__pb2.SimulateRequest.FromString,
                    response_serializer=simulation__pb2.SimulateResponse.SerializeToString,
            ),
    }
...
class SimulationService(object):
    ...
    def Simulate(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/simulation.SimulationService/Simulate',
            simulation__pb2.SimulateRequest.SerializeToString,
            simulation__pb2.SimulateResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
